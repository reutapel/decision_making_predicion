...
def main():
    ...
    reviews = pd.read_excel(os.path.join(data_directory, 'manual_binary_features_test_data.xlsx'),
    ...
    joblib.dump(reviews, (os.path.join(data_directory, 'bert_embedding_test_data.pkl')))
